...
import dev.flammky.valorantcompanion.live.pvp.ingame.presentation.LiveInGameScreenState
    ...
    private inner class StateProducer(
        ...
        private fun onFetchSuccess(
            ...
            mutateState("onFetchSuccess") { state ->
                state.copy(
                    activeSpraysKey = Any(),
                    activeSprays = data.sprays.toPersistentList(),
                )
            }
        }
        ...
        private fun onFetchFailure(
            ...
            Log.d(
                BuildConfig.LIBRARY_PACKAGE_NAME,
                "live.loadout.presentation.SprayLoadoutPickerPresenterKt: StateProducer_onFetchSuccess()"
            )
