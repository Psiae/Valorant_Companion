...
object ValorantSeasons {
    ...
    val CLOSED_BETA = ValorantSeason(
        ValorantEpisode(
            ...
            start = ISO8601.fromStr("2020-04-07T13:15:00Z"),
            end = ISO8601.fromStr("2020-05-30T04:14:00Z")
        ),
        emptyList()
    )
    ...
    val EPISODE_1 = ValorantSeason(
        ValorantEpisode(
            ...
            num = 1,
            codeName = "IGNITION",
            start = ISO8601.fromStr("2020-06-02T04:15:00Z"),
            end = ISO8601.fromStr("2021-01-12T21:15:00Z")
        ),
        persistentListOf(
            ValorantAct(
                ...
                num = 1,
                start = ISO8601.fromStr("2020-06-02T04:15:00Z"),
                end = ISO8601.fromStr("2020-08-04T21:15:00Z")
            ),
            ValorantAct(
                id = "0530b9c4-4980-f2ee-df5d-09864cd00542",
                num = 2,
                start = ISO8601.fromStr("2020-08-04T21:15:00Z"),
                end = ISO8601.fromStr("2020-10-13T21:15:00Z")
            ),
            ValorantAct(
                id = "46ea6166-4573-1128-9cea-60a15640059b",
                num = 3,
                start = ISO8601.fromStr("2020-10-13T21:15:00Z"),
                end = ISO8601.fromStr("2021-01-12T21:15:00Z")
            )
        )
    )
    ...
    val EPISODE_2 = ValorantSeason(
        ValorantEpisode(
            ...
            num = 2,
            codeName = "FORMATION",
            start = ISO8601.fromStr("2021-01-12T21:15:00Z"),
            end = ISO8601.fromStr("2021-06-22T21:15:00Z")
        ),
        persistentListOf(
            ValorantAct(
                ...
                num = 1,
                start = ISO8601.fromStr("2021-01-12T21:15:00Z"),
                end = ISO8601.fromStr("2021-03-02T21:15:00Z")
            ),
            ValorantAct(
                id = "ab57ef51-4e59-da91-cc8d-51a5a2b9b8ff",
                num = 2,
                start = ISO8601.fromStr("2021-03-02T21:15:00Z"),
                end = ISO8601.fromStr("2021-04-27T21:15:00Z")
            ),
            ValorantAct(
                id = "52e9749a-429b-7060-99fe-4595426a0cf7",
                num = 3,
                start = ISO8601.fromStr("2021-04-27T21:15:00Z"),
                end = ISO8601.fromStr("2021-06-22T21:15:00Z")
            )
        )
    )
    ...
    val EPISODE_3 = ValorantSeason(
        ValorantEpisode(
            ...
            num = 3,
            codeName = "REFLECTION",
            start = ISO8601.fromStr("2021-06-22T21:15:00Z"),
            end = ISO8601.fromStr("2022-01-11T21:15:00Z")
        ),
        persistentListOf(
            ValorantAct(
                ...
                num = 1,
                start = ISO8601.fromStr("2021-06-22T21:15:00Z"),
                end = ISO8601.fromStr("2021-09-08T21:15:00Z")
            ),
            ValorantAct(
                id = "4cb622e1-4244-6da3-7276-8daaf1c01be2",
                num = 2,
                start = ISO8601.fromStr("2021-09-08T21:15:00Z"),
                end = ISO8601.fromStr("2021-11-02T21:15:00Z")
            ),
            ValorantAct(
                id = "a16955a5-4ad0-f761-5e9e-389df1c892fb",
                num = 3,
                start = ISO8601.fromStr("2021-11-02T21:15:00Z"),
                end = ISO8601.fromStr("2022-01-11T21:15:00Z")
            )
        )
    )
    ...
    val EPISODE_4 = ValorantSeason(
        ValorantEpisode(
            ...
            4,
            "DISRUPTION",
            ISO8601.fromStr("2022-01-11T21:15:00Z"),
            ISO8601.fromStr("2022-06-21T21:15:00Z")
        ),
        persistentListOf(
            ValorantAct(
                ...
                1,
                ISO8601.fromStr("2022-01-11T21:15:00Z"),
                ISO8601.fromStr("2022-03-01T21:15:00Z")
            ),
            ValorantAct(
                "d929bc38-4ab6-7da4-94f0-ee84f8ac141e",
                2,
                ISO8601.fromStr("2022-03-01T21:15:00Z"),
                ISO8601.fromStr("2022-04-26T21:15:00Z")
            ),
            ValorantAct(
    ...
    val EPISODE_5 = ValorantSeason(
        ValorantEpisode(
            ...
            "DIMENSION",
            ISO8601.fromStr("2022-06-21T21:15:00Z"),
            ISO8601.fromStr("2023-01-10T21:15:00Z")
        ),
        persistentListOf(
            ValorantAct(
                ...
                1,
                ISO8601.fromStr("2022-06-21T21:15:00Z"),
                ISO8601.fromStr("2022-08-23T21:15:00Z")
            ),
            ValorantAct(
                "7a85de9a-4032-61a9-61d8-f4aa2b4a84b6",
                2,
                ISO8601.fromStr("2022-08-23T21:15:00Z"),
                ISO8601.fromStr("2022-10-18T21:15:00Z")
            ),
            ValorantAct(
    ...
    val EPISODE_6 = ValorantSeason(
        ValorantEpisode(
            ...
            "REVELATION",
            ISO8601.fromStr("2023-01-10T21:15:00Z"),
            ISO8601.fromStr("2023-06-27T21:15:00Z")
        ),
        persistentListOf(
            ValorantAct(
                ...
                1,
                ISO8601.fromStr("2023-01-10T21:15:00Z"),
                ISO8601.fromStr("2023-03-07T21:15:00Z")
            ),
            ValorantAct(
                "34093c29-4306-43de-452f-3f944bde22be",
                2,
                ISO8601.fromStr("2023-03-07T21:15:00Z"),
                ISO8601.fromStr("2023-04-25T21:15:00Z")
            ),
            ValorantAct(
